...
namespace SignalR.Restaurant.DataAccess.Migrations
{
    ...
    [Migration("20241215005049_add_mig_message")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.Basket", b =>
                {
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.MenuTable", b =>
                {
                    b.Property<int>("MenuTableID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.Message", b =>
                {
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.MoneyCase", b =>
                {
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.Order", b =>
                {
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.Slider", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SignalR.Restaurant.Entities.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SignalR.Restaurant.Entities.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.Basket", b =>
                {
                    b.HasOne("SignalR.Restaurant.Entities.Entities.MenuTable", "MenuTable")
                        .WithMany("Baskets")
                        .HasForeignKey("MenuTableID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SignalR.Restaurant.Entities.Entities.Product", "Product")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("SignalR.Restaurant.Entities.Entities.OrderDetail", b =>
                {
                    b.HasOne("SignalR.Restaurant.Entities.Entities.Order", "Order")
